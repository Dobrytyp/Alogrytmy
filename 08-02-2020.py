...
# Napisz program znajdujący tak podział listy, by wartość bezwzględna sum elementów po lewej stronie i elementów
...
# lista = list(range(0, 20, 3)) # To jest stały element
#
# def get_sum(lista):
#     suma = 0
#     for i in lista:
